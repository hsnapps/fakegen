...
return [
    ...
    'internet' => [
        ...
        'password' => [
            ...
            'init' => null,
            'type' => 'number',
            'help' => 'Generate a password, with a given minimum and maximum length. By default, the values 6 and 20 are used for the minimum and maximum respectively.',
        ],
        'domainName' => [
            'title' => 'Domain Name',
            'size' => null,
    ...
    'useragent' => [
        ...
        'opera' => [
            ...
            'init' => null,
            'type' => null,
            'help' => 'Opera/8.55 (Windows 95; en-US) Presto/2.9.286 Version/11.00',
        ],
        'internetExplorer' => [
    ...
    'payment' => [
        ...
        'invalid-creditCardExpirationDateString' => [
            'title' => 'Credit Card Expiration Date',
            'size' => null,
            'min' => null,
            'max' => null,
            'init' => null,
            'type' => null,
            'help' => 'Generate an INVALID credit card expiration date.',
        ],
        'iban' => [
            'title' => 'IBAN',
            'size' => null,
            ...
            'init' => null,
            'type' => null,
            'help' => "Generate an IBAN string with a given country and bank code. By default, a random country and bank code will be used: 'LI2690204NV3C0BINN164', 'NL56ETEE3836179630'",
        ],
        'swiftBicNumber' => [
